...
| [09_ui-review.md](09_ui-review.md) | 화면 점검 SSOT — 캡처→점검→수정 루프 · 공통 점검 8항 · 화면별 대장 |
| [10_ux-plan.md](10_ux-plan.md) | UX 재설계 계획 — 2026-08-22 사용자 지적 9건의 진단·결정·단계 |
| [11_polish-loop.md](11_polish-loop.md) | **상용 품질 루프** — 결함 클래스 전수 감사(모드 A) → 졸업 순회(모드 B)·종료 기준 (P1~P25·회차 기록. 2026-08-23 개정 — 화면 무한 순회 중지) |
